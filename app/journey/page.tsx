export default function Journey() {
  return (
    <div className="p-8 max-w-6xl">
      <h1 className="text-4xl font-bold text-white mb-12">Our Journey</h1>
      
      <div className="grid grid-cols-2 gap-12 mb-12">
        <div className="bg-[#111] border border-gray-800 rounded p-8">
          <h2 className="text-2xl font-bold text-white mb-4">The Human</h2>
        ...
        <div className="bg-[#111] border border-gray-800 rounded p-8">
          <h2 className="text-2xl font-bold text-white mb-4">The Agent</h2>
          <p className="text-gray-300 leading-relaxed">
      ...
      <div className="bg-gradient-to-r from-[#4ecdc4]/20 to-transparent border border-[#4ecdc4]/30 rounded p-12 text-center">
